...
use App\Http\Controllers\Saas\Admin\BlogCategoryController;
use App\Http\Controllers\Saas\Admin\BlogController;
...
Route::group(['prefix' => 'payment'], function () {
    ...
    Route::match(array('GET', 'POST'), 'subscription/failed', [PaymentSubscriptionController::class, 'failed'])->name('payment.subscription.failed');
    Route::match(array('GET', 'POST'), 'subscription/webhook', [PaymentSubscriptionController::class, 'webhook'])->name('payment.subscription.webhook');
});
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::group(['prefix' => 'packages', 'as' => 'packages.'], function () {
        ...
        Route::get('get-info-packages', [PackageController::class, 'getInfoPackage'])->name('get.info.packages');
        Route::post('owner-packages-status-update', [PackageController::class, 'ownerPackagesStatusUpdate'])->name('owner.packages.status.update');
    ...
    Route::group(['prefix' => 'blog', 'as' => 'blogs.'], function (){
        ...
        Route::group(['prefix' => 'category', 'as' => 'categories.'], function (){
            ...
            Route::get('get-info', [BlogCategoryController::class, 'getInfo'])->name('get.info');
            Route::delete('destroy/{id}', [BlogCategoryController::class, 'destroy'])->name('destroy');
        });

        Route::get('/', [BlogController::class, 'index'])->name('index');
        Route::post('store', [BlogController::class, 'store'])->name('store');
        Route::get('get-info', [BlogController::class, 'getInfo'])->name('get.info');
