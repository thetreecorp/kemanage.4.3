...
Route::group(['middleware' => ['version.update', 'addon.update', 'isFrontend']], function () {
    ...
    Route::get('/language-change/{languageCode}', [CommonController::class, 'languageChanage'])->name('language-Chanage');
    Route::get('/country/{code}', [CommonController::class, 'changeCountry'])->name('country.change');
    Route::post('/currency', [CommonController::class, 'currencyChanage'])->name('currency-Chanage');
