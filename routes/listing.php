...
Route::group(['prefix' => 'owner', 'as' => 'owner.', 'middleware' => ['auth', 'owner']], function () {
    Route::group(['prefix' => 'listing', 'as' => 'listing.'], function () {
        Route::get('/', [ListingController::class, 'index'])->name('index')->middleware('can:Manage Listing');
        Route::get('create', [ListingController::class, 'create'])->name('create')->middleware('can:Manage Listing');
        ...
        Route::get('contact', [ListingController::class, 'contact'])->name('contact')->middleware('can:Manage Listing');
