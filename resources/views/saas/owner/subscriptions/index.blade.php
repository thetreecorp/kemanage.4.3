                            ...
                            @if (!is_null($userPlan))
                                <div class="card">
                                    <div class="card-header border-bottom-0">
                                        <div class="current-plan d-flex align-items-center flex-wrap g-10">
                                                ...
                                                <div class="plan-usage-list">
                                                    ...
                                                    <div class="d-flex mb-2">
                                                        ...
                                                        <h4 class="flex-grow-1 ms-1">
                                                            {{ getExistingProperty(getOwnerUserId()) }} /
                                                    ...
                                                    <div class="d-flex mb-2">
                                                        <i class="ri-checkbox-circle-line"></i>
                                                        <h4 class="flex-grow-1 ms-1">
                                                            {{ getExistingUnit(getOwnerUserId()) }} /
                                                            {{ $userPlan->max_unit }} {{ __('Units') }}
                                                        </h4>
                                                    </div>
                                                    ...
                                                    <div class="d-flex mb-2">
                                                        <i class="ri-checkbox-circle-line"></i>
                                                        <h4 class="flex-grow-1 ms-1">
                                                            {{ getExistingMaintainers(getOwnerUserId()) }} /
                                                    ...
                                                    {{-- <div class="d-flex mb-2">
                                                        <i class="ri-checkbox-circle-line"></i>
                                                        <h4 class="flex-grow-1 ms-1">
                                                            {{ getExistingTenant(getOwnerUserId()) }} /
                                                    ...
                                                    <div class="d-flex mb-2">
                                                        <i class="ri-checkbox-circle-line"></i>
                                                        <h4 class="flex-grow-1 ms-1">
                                                            {{ getExistingInvoice(getOwnerUserId()) }} /
                                                    ...
                                                    <div class="d-flex mb-2">
                                                        <i class="ri-checkbox-circle-line"></i>
                                                        <h4 class="flex-grow-1 ms-1">
                                                            {{ getExistingAutoInvoice(getOwnerUserId()) }} /
                                                    ...
                                                    @foreach (getPackageOtherFields(getOwnerUserId()) ?? [] as $field)
                                                        <div class="d-flex mb-2">
                                                            <i class="ri-checkbox-circle-line"></i>
                                                            <h4 class="flex-grow-1 ms-1">
                                                                {{ $field }}
