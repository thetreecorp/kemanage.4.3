...
@section('content')
    <div>
        <div class="container-fluid p-0">
                ...
                <div class="col-lg-12">
                    <div class="properties-filter">
                        <form action="{{ route('listings') }}" method="GET" id="searchForm">
                            <div class="first-filter flex-wrap">
                    ...
                    <div class="col-lg-8 pe-lg-5 margin-top-1">
                        <div class="alert alert-danger text-center mb-0" role="alert">
                            @if (env('LOGIN_HELP') == 'active')
                                <p>
                                    To access this page, you need to purchase the <strong><a href="{{LISTING_ADDON}}" target="_blank">Listing Addon</a></strong>.
                                    note: All Addon will not work without the <strong><a href="{{LINK_MAIN_SCRIPT}}" target="_blank">Main Script</a></strong>.
                                        ...
                                        <div class="single-properties mb-0 h-100">
                                            ...
                                            <div class="properties-text-info">
                                                ...
                                                <a href="{{ route('listing.details', $listing->slug) }}"
                                                   class="theme-btn py-16 px-30 text-nowrap mt-10">{{ __('View Details') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            @else
                <div class="no-data-property text-center mt-15">
                    {{ __('No Data Found') }}
                </div>
            @endif
        </div>
